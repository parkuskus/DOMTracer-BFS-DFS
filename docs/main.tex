...
\setlength{\headheight}{60pt}   % wajib cukup besar untuk fancyhdr
\setlength{\headsep}{24pt}      % jarak header ke teks
...
\begin{titlepage}
	...
	% ---------- Gambar tengah ----------
	\vspace{1.8cm}
	\includegraphics[width=0.8\textwidth]{public/foto-kelompok.png}\par
